...
public class SensorRecordController {
	...
	public void createRecord(@RequestBody SensorRecordRequestModel recordRequestModel) {
	...
	public ResponseEntity<RecordQueryResponseModel> queryRecords(@RequestBody RecordQueryRequestModel requestModel) {
